...
The required setup:
  - All your use of the <ui:msg> markup in the xml file MUST contain
    ...
    messages.
  - You need the file
      l10n/LocalizableResource.properties
  ...
  - You need to GWT-compile your project with the "-extra" additional arguments to
